...
x_train = np.zeros((4000,WIDTH,HEIGHT,3),dtype=np.float)
x_test = np.zeros((1000,WIDTH,HEIGHT,3),dtype=np.float)
y_train = np.zeros((4000),dtype=np.float)
y_test = np.zeros((1000),dtype=np.float)
